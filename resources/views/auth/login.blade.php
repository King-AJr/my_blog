...
<!-- Mirrored from reiro.fueko.net/signin/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Jan 2023 12:52:10 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>Reiro — Welcome back!</title>
    ...
    <meta property="og:url" content="https://reiro.fueko.net/signin/" />
    <meta property="og:image"
        content="https://reiro.fueko.net/content/images/2022/10/uby-yanes-mAgNvtRlGzA-unsplash.jpg" />
    <meta property="article:published_time" content="2019-12-05T11:13:34.000Z" />
    <meta property="article:modified_time" content="2022-10-10T13:52:35.000Z" />
    <meta property="article:publisher" content="https://www.facebook.com/ghost" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Welcome back!" />
    <meta name="twitter:description"
        content="A minimal, functional theme for running a paid-membership publication on Ghost." />
    <meta name="twitter:url" content="https://reiro.fueko.net/signin/" />
    ...
    <script type="application/ld+json">
{
    ...
    "url": "https://reiro.fueko.net/signin/",
    "datePublished": "2019-12-05T11:13:34.000Z",
    "dateModified": "2022-10-10T13:52:35.000Z",
    "image": {
        "@type": "ImageObject",
        "url": "https://reiro.fueko.net/content/images/2022/10/uby-yanes-mAgNvtRlGzA-unsplash.jpg",
        "width": 1920,
        "height": 2398
    },
    "mainEntityOfPage": {
    ...
    <style>
        :root {
            --ghost-accent-color: #f9c345;
        }
    </style>
</head>

<body class="page-template page-signin custom-page">
    <script>
        ! function() {
            "use strict";
    ...
    <div class="custom-wrap">
        <div class="custom-container">
            <div class="custom-logo-wrap">
                <div class="custom-logo global-logo is-header"> <a href="../index.html" class="is-logo"><img
                            src="../content/images/2022/10/reiro.svg" alt="Reiro home"></a>
                </div>
            </div>
            <div class="custom-content">
                <form method="post" action="{{ route('login') }}">@csrf
                    <h1 class="custom-title">Welcome back!</h1>
                    <input type="email" placeholder="Your email address" name="email"
                        aria-label="Your email address" required>
                    <input type="password" placeholder="Your password" name="password" aria-label="Your password"
                        required>
                    <button class="global-button">Sign-in</button>

                    <small class="global-question"><span>Don’t have an account yet?</span> <a
    ...
    <script>
        ! function() {
            window.onscroll = (event) => {
                ...
                a.innerHTML = "See all Themes \u2192", a.setAttribute("class", "is-banner"), a.href =
                    "https://fueko.net/themes/", a.target = "_blank", a.rel = "noopener", document.body.appendChild(a),
                    window.onscroll = function(a) {
                        n = document.body, window.innerHeight + window.scrollY >= document.body.offsetHeight ? n
                            .classList.add("is-scroll-banner") : n.classList.remove("is-scroll-banner")
                    }
            }
        }();
    </script>
...
<!-- Mirrored from reiro.fueko.net/signin/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Jan 2023 12:52:12 GMT -->
