...
<!-- Mirrored from reiro.fueko.net/signup/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Jan 2023 12:53:35 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
		<meta charset="utf-8">
		<meta http-equiv="X-UA-Compatible" content="IE=edge">
		<title>Reiro — Create Account</title>
...
:root {
    ...
    <meta property="og:description" content="A minimal, functional theme for running a paid-membership publication on Ghost." />
    <meta property="og:url" content="https://reiro.fueko.net/signup/" />
    <meta property="og:image" content="https://reiro.fueko.net/content/images/2022/10/uby-yanes-X3GqOzEklYI-unsplash.jpg" />
    <meta property="article:published_time" content="2019-12-13T21:39:25.000Z" />
    <meta property="article:modified_time" content="2022-10-10T13:47:54.000Z" />
    <meta property="article:publisher" content="https://www.facebook.com/ghost" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Create Account" />
    <meta name="twitter:description" content="A minimal, functional theme for running a paid-membership publication on Ghost." />
    <meta name="twitter:url" content="https://reiro.fueko.net/signup/" />
    <meta name="twitter:image" content="https://reiro.fueko.net/content/images/2022/10/uby-yanes-X3GqOzEklYI-unsplash.jpg" />
    ...
    <script type="application/ld+json">
{
    ...
    "author": {
        ...
        "image": {
            "@type": "ImageObject",
            "url": "https://reiro.fueko.net/content/images/2022/10/viktor-zhulin-PhA_DqZyicI-unsplash.jpg",
            "width": 1920,
            "height": 2560
        },
        "url": "https://reiro.fueko.net/author/brenda/",
        "sameAs": [
            "https://fueko.net",
    ...
    "url": "https://reiro.fueko.net/signup/",
    "datePublished": "2019-12-13T21:39:25.000Z",
    "dateModified": "2022-10-10T13:47:54.000Z",
    "image": {
        "@type": "ImageObject",
        "url": "https://reiro.fueko.net/content/images/2022/10/uby-yanes-X3GqOzEklYI-unsplash.jpg",
        "width": 1920,
        "height": 2398
    },
    "mainEntityOfPage": {
    ...
    <link rel="alternate" type="application/rss+xml" title="Reiro" href="../rss/index.html" />
    <script defer src="https://cdn.jsdelivr.net/ghost/portal@~2.19/umd/portal.min.js" data-ghost="https://reiro.fueko.net/" data-key="3d825fc0e10091ccd9cd5c1f35" data-api="https://reiro.fueko.net/ghost/api/content/" crossorigin="anonymous"></script><style id="gh-members-styles">.gh-post-upgrade-cta-content,
.gh-post-upgrade-cta {
    display: flex;
...
.gh-post-upgrade-cta a.gh-btn:hover {
    ...
    <script defer src="https://cdn.jsdelivr.net/ghost/sodo-search@~1.1/umd/sodo-search.min.js" data-key="3d825fc0e10091ccd9cd5c1f35" data-styles="https://cdn.jsdelivr.net/ghost/sodo-search@~1.1/umd/main.css" data-sodo-search="https://reiro.fueko.net/" crossorigin="anonymous"></script>
    ...
    <script defer src="../public/comment-counts.min85ba.js?v=1924d1ca6a" data-ghost-comments-counts-api="https://reiro.fueko.net/members/api/comments/counts/"></script>
    <script defer src="../public/member-attribution.min85ba.js?v=1924d1ca6a"></script>
    <style>:root body{--opacity-cover:15%}</style>
<style>.item.is-top.is-first .item-image{aspect-ratio:4/3.05}.subscribe-form{padding:28px 34px 32px}.subscribe-title{margin:0 0 2.4vh}@media (max-width:1480px){.subscribe-form{padding:30px}}@media (max-width:1280px){.subscribe-form{padding:26px 2vw}}@media (max-width:1024px){.subscribe-form{padding:20px}}.post-sidebar .subscribe-form{padding:22px 25px 25px}.footer-section .subscribe-form{padding:20px 26px 28px}</style>
<script data-host="https://microanalytics.io" data-dnt="false" src="https://microanalytics.io/js/script.js" id="ZwSg9rf6GA" async defer></script>
<style>body.is-scroll-banner .is-banner{bottom:30px}.is-banner{font-size:24px;position:fixed;z-index:9999;right:2%;bottom:-100px;display:inline-block;padding:2px 10px;transition-timing-function:ease;transition-duration:.5s;transition-property:bottom,transform;color:#171822;border-radius:100px;background-color:#97fe65}.is-banner,.is-banner:hover{color:#171822}.is-banner:hover{transform:translateY(-3px)}@media (max-width:1024px){.is-banner{display:none!important}}</style><style>:root {--ghost-accent-color: #f9c345;}</style>
	</head>
	<body class="page-template page-signup custom-page">
		<script>!function(){"use strict";const t=document.body,o=getComputedStyle(t).getPropertyValue("--ghost-accent-color").trim();o&&t.classList.add(getContrast(o))}();</script>
		<div class="custom-wrap">
	<div class="custom-container">
		<div class="custom-logo-wrap">
			<div class="custom-logo global-logo is-header">	<a href="../index.html" class="is-logo"><img src="../content/images/2022/10/reiro.svg" alt="Reiro home"></a>
</div>
		</div>
		<div class="custom-content">
			<form method="post" action="{{route('register')}}">@csrf
                ...
                <p>{{$err}}</p>
                @endforeach
				<h1 class="custom-title">Create Account</h1>
				<input  type="text"
                ...
                <input type="password"
                 placeholder="*******"
                  name="password" aria-label="Your password"
                   required>
                <input  type="password"
                  ...
                  :value="__('Confirm Password')"
                   name="password_confirmation"
                    aria-label="Confirm password"
                     ...
                     <input  type="file"
                   name="image"
                    aria-label="Input your image"
                     required>
				<button class="global-button">Continue</button>
				<div>

				</div>
				<small class="global-question"><span>Already have an account?</span> <a href="{{route('login')}}">Sign in</a></small>
			</form>
			<div class="alert-success">
				<h2 class="global-title">Great!</h2>
				<p>Please check your inbox and click the link to confirm your signup.</p>
				<a href="../index.html" class="global-button">Back to homepage</a>
			</div>
		</div>
	</div>
	<div class="custom-image global-bg-image" style="background-image: url(../content/images/2022/10/uby-yanes-X3GqOzEklYI-unsplash.jpg)"></div>
</div>
...
<!-- Mirrored from reiro.fueko.net/signup/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Jan 2023 12:53:37 GMT -->
</html>
